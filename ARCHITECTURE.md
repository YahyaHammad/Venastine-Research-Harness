...
│   ├── widgets.py                 # transcript (Rich Syntax highlighting), raven panels, research progress, GoalBanner; LINKED_ROLES (batch 65) says which lines arm a URL for ctrl+click, and `_links` carries the click target for one the digest truncated
