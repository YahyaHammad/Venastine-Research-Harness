...
D-number, changes a file-level contract in docs/ARCHITECTURE.md, or touches core/loop.py,
core/client.py, tools/registry.py or the security/ boundaries. See docs/CONTRIBUTING.md.
-->
...
By opening this PR you agree your contribution is licensed under Apache-2.0 (see docs/CONTRIBUTING.md).
